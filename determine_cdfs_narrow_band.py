"""
Narrowband photometric calibration of the CDFS narrow band
Exactly the same as the determine narrowband_zpt.py

This is a script. Don't hate me.

This works by changing the straight line functions in the bottom and upper 
limit functions.
"""
...
INFILE_SEX = '../CDFS_LAGER/n964_cdfs.cat'
