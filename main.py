...
def make_wide_band_mags(decam_df: pd.DataFrame, panstars_cat: pd.DataFrame, band: str) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    ...
    mag_diff, mag_diff_err = calculate_difference_between_mags(dec_mags, dec_mags_uncertainty, converted_mags, converted_mags_errors)
...
def calculate_difference_between_mags(decam_mags, decam_mags_uncertainties, converted_decam_mags, converted_decam_mags_uncertainties):
